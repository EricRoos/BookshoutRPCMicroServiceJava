...
public class ListData extends org.apache.thrift.TUnion<ListData, ListData._Fields> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC            = new org.apache.thrift.protocol.TStruct(
            "ListData");
    private static final org.apache.thrift.protocol.TField  PROMO_CODES_FIELD_DESC = new org.apache.thrift.protocol.TField(
            "promoCodes", org.apache.thrift.protocol.TType.LIST, (short) 1);
    private static final org.apache.thrift.protocol.TField  PROMOS_FIELD_DESC      = new org.apache.thrift.protocol.TField(
            "promos", org.apache.thrift.protocol.TType.LIST, (short) 2);
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
        PROMO_CODES((short) 1, "promoCodes"), PROMOS((short) 2, "promos");
    ...
    static {
        Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
                _Fields.class);
        tmpMap.put(_Fields.PROMO_CODES,
                new org.apache.thrift.meta_data.FieldMetaData("promoCodes",
                        org.apache.thrift.TFieldRequirementType.DEFAULT,
                        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                        PromoCode.class))));
        tmpMap.put(_Fields.PROMOS,
                new org.apache.thrift.meta_data.FieldMetaData("promos", org.apache.thrift.TFieldRequirementType.DEFAULT,
                        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
                                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
                                        Promo.class))));
    ...
    protected void checkType(_Fields setField, Object value) throws ClassCastException {
        ...
        case PROMO_CODES:
            ...
            throw new ClassCastException("Was expecting value of type List<PromoCode> for field 'promoCodes', but got "
                    + value.getClass().getSimpleName());
        case PROMOS:
            if (value instanceof List) {
                break;
            }
            throw new ClassCastException("Was expecting value of type List<Promo> for field 'promos', but got "
                    + value.getClass().getSimpleName());
        default:
    ...
    protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot)
        ...
        case PROMO_CODES:
            ...
            oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, promoCodes.size()));
        ...
        case PROMOS:
            ...
            oprot.writeListBegin(
                    new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, promos.size()));
    ...
    public List<PromoCode> getPromoCodes() {
        if (getSetField() == _Fields.PROMO_CODES) {
            ...
            throw new RuntimeException("Cannot get field 'promoCodes' because union is currently set to "
    ...
    public List<Promo> getPromos() {
        if (getSetField() == _Fields.PROMOS) {
            ...
            throw new RuntimeException(
                    "Cannot get field 'promos' because union is currently set to " + getFieldDesc(getSetField()).name);
        }
    }
