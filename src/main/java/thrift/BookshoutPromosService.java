...
public class BookshoutPromosService {
  ...
  public interface Iface {
    ...
    public List<PromoCode> getPromoCodes(Promo promo) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<PromoCode> recv_getPromoCodes() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getPromoCodes_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<PromoCode> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getPromoCodes<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPromoCodes_args, List<PromoCode>> {
      public getPromoCodes() {
        super("getPromoCodes");
      }
      ...
      public AsyncMethodCallback<List<PromoCode>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<PromoCode>>() { 
          public void onComplete(List<PromoCode> o) {
            getPromoCodes_result result = new getPromoCodes_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getPromoCodes_args args, org.apache.thrift.async.AsyncMethodCallback<List<PromoCode>> resultHandler) throws TException {
  ...
  public static class getPromoCodes_result implements org.apache.thrift.TBase<getPromoCodes_result, getPromoCodes_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPromoCodes_result>   {
    ...
    public List<PromoCode> success; // required
    ...
    public getPromoCodes_result(getPromoCodes_result other) {
      if (other.isSetSuccess()) {
        List<PromoCode> __this__success = new ArrayList<PromoCode>(other.success.size());
        for (PromoCode other_element : other.success) {
          __this__success.add(new PromoCode(other_element));
        }
    ...
    public java.util.Iterator<PromoCode> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(PromoCode elem) {
      if (this.success == null) {
        this.success = new ArrayList<PromoCode>();
      }
      this.success.add(elem);
    }

    public List<PromoCode> getSuccess() {
      return this.success;
    }

    public getPromoCodes_result setSuccess(List<PromoCode> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<PromoCode>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<PromoCode>(_list0.size);
                  PromoCode _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPromoCodes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (PromoCode _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (PromoCode _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<PromoCode>(_list5.size);
            PromoCode _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new PromoCode();
              _elem6.read(iprot);
